...
### ⚒ Project Demo:
####  For Project Demo Follow the Link: http://shopping-basket.surge.sh/

### 🕵️‍♂️ Project Details:
####  This project is based on primarily on React TypeScript as well as uses other libraries too. In this app, you can use shop and cart!

### ⚙ Technical Details:
#### In this project, React with TypeScript is used for the project. Other Libraries used includes Material-UI, TypeScript, FontAwesome, ReduxJS-Toolkit, Styled-Components, Bootstap, React-Redux, React-Router, MirageJS and React-Toastify.
...
![Styled Components](https://img.shields.io/badge/-Styled%20Component-333333?style=for-the-badge&logo=styled-components)&nbsp;&nbsp;&nbsp;&nbsp;
...
<p align="center">
  <a href="http://shopping-basket.surge.sh/">
